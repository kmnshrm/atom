...
const NavigationBar = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'c18a55253b6e22b6f4e660a11c41b49f3ee3d665', style: vars, class: hostClass, "data-theme": this.effectiveTheme }, h("div", { key: '7f470ff71b8be5e5972ce681a84bf65cbd5753b0', class: "nav-glider", style: {
            ...
            } }), this.renderToggle(), this.isMobile && this.isExpanded && h("div", { key: '359fadd9711e64a9341487949e241a6b70ac0c75', class: "nav-backdrop", onClick: () => this.close() }), h("div", { key: '5a704617eeaa80507d06b2eba687580e2684d999', class: "nav-blocks-container" }, h("div", { key: 'a866d84ed734fb5d90e5eb39a238139117c3add6', class: "nav-header" }, h("slot", { key: '9ce0fa39842a3e0293fb0b64cd83a8cef82db1a8', name: "header" }, (this.companyLogo || this.companyName) && (h("div", { key: 'a8fff1a1858bc2980dc97186c2c0e4d266040f47', class: "nav-company-block", style: { display: 'flex', alignItems: 'center', gap: '12px', padding: '0 24px', height: '64px' } }, this.companyLogo && h("img", { key: 'e9adbcfe91eac77c181acdabf05631d0da0c16e5', src: this.companyLogo, alt: this.companyName || 'Logo', style: { height: '32px', width: 'auto' } }), this.isExpanded && this.companyName && (h("span", { key: '024e91dcae750a76ad1c7b6f2ace9c827ae8f15c', class: "nav-company-name", style: { fontWeight: '600', fontSize: '16px' } }, this.companyName))))), h("slot", { key: 'ef9a2ab5e60ba2e4ab8ea5627805061ec6fce0aa', name: "logo" }), this.isMobile && (h("div", { key: '29415d64e83b8c4c9c8157b6cc8100a23c2e2f83', class: "nav-mobile-close", onClick: () => this.close() }, h("svg", { key: '9bba2cd204d3e07e578f027d375fab8d2737e1cb', viewBox: "0 0 24 24", width: "24", height: "24", stroke: "currentColor", fill: "none" }, h("path", { key: '3ecc975768c3ed0c04efee4a1734d476ea40a51c', d: "M18 6L6 18M6 6l12 12" }))))), this.showSearch && this.isExpanded && (h("div", { key: '022f551a810e6f1cc11bec32ccfff44027a3bdc3', class: "nav-search-bar" }, h("div", { key: '4e482e4581337c19247841ddf62421022064ce3a', style: {
                position: 'relative',
                display: 'flex',
                alignItems: 'center',
                ...
                borderRadius: '6px',
                padding: '4px 8px',
            } }, h("svg", { key: 'a70ca488b988aa1ccfa3f64b7906a35d964f437a', viewBox: "0 0 24 24", width: "16", height: "16", fill: "none", stroke: "currentColor", "stroke-width": "2", style: { opacity: '0.5', marginRight: '8px' } }, h("circle", { key: '5c41a790ae0426261a3603322beae04d5b124ba6', cx: "11", cy: "11", r: "8" }), h("line", { key: '22092bedda6e64f6cb9043258bb34378b6d1f0ca', x1: "21", y1: "21", x2: "16.65", y2: "16.65" })), h("input", { key: '96840e15db673cdd523fe1252a29fef9ab7ab872', type: "text", placeholder: "Search...", value: this.keyword, onInput: e => (this.keyword = e.target.value), style: {
                ...
                fontSize: '14px',
                color: 'inherit',
            } })))), blocks.categories.length > 0 && (h("div", { key: '7a2ef1fd7440dae7a5459ff1b67b39f797846d97', class: "nav-block-categories", role: "tree" }, this.renderNavList(blocks.categories, 'cat'))), h("div", { key: '1c97c25cb50a8486a47c3f74cf5ede75efa30989', class: "nav-block-top", role: "tree" }, this.renderNavList(blocks.primary, 'top'), h("slot", { key: '0cbef05cadac496b5f460343aff2a84f6aec4eee', name: "menu-item" }), " ", blocks.primary.length === 0 && blocks.categories.length === 0 && blocks.secondary.length === 0 && h("slot", { key: '20cbe4c6caadbb9e8302754587b6e686354ad9ab', name: "empty-state" }, "No Items")), blocks.secondary.length > 0 && (h("div", { key: '2ea451618cc7b671739bcc80913e1a4715d979bb', class: "nav-block-secondary", role: "tree" }, this.renderNavList(blocks.secondary, 'sec'))), blocks.bottom.length > 0 && (h("div", { key: 'b69c53381c10df9ee40bcd36a55264ba7f4e128b', class: "nav-block-bottom", role: "tree" }, blocks.bottom.map(item => this.renderItem(item)), h("slot", { key: '40099b35cea2554f54a5867253c737c01732b4ec', name: "footer" }))), blocks.bottomSecondary.length > 0 && (h("div", { key: '91953fbc1b1d4607d91e060cf0e16db4b26d6210', class: "nav-block-profile", role: "tree" }, blocks.bottomSecondary.map(item => this.renderItem(item)))))));
    }
    isBottomItem(id) {
        const blocks = this.getBlocks();
